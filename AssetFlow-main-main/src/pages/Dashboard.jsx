    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          <button className="btn btn-secondary" onClick={() => setIsModalOpen(true)}>Register Asset</button>
          <button className="btn btn-primary" onClick={() => setIsBookModalOpen(true)}>Book Resource</button>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <button className="btn btn-secondary" style={{ justifyContent: 'flex-start', padding: '1rem' }} onClick={() => setIsModalOpen(true)}>
              <Box size={18} style={{ color: 'var(--primary-color)' }} />
              Register New Asset
            </button>
            <button className="btn btn-secondary" style={{ justifyContent: 'flex-start', padding: '1rem' }} onClick={() => setIsBookModalOpen(true)}>
              <CalendarCheck size={18} style={{ color: 'var(--secondary-color)' }} />
              Book a Resource
            </button>
            <button className="btn btn-secondary" style={{ justifyContent: 'flex-start', padding: '1rem' }} onClick={() => setIsMaintenanceModalOpen(true)}>
